...
// DS18 Sensor read implementation
...
double get_pressure(int channelNumber, double pressure) {
 //t = bmp.readPressure() / pow(2.718281828, -(Wys / ((273.15 + bmp.readTemperature()) * 29.263))) / 100.0  
    
    pressure = bmp.readPressure() / pow(2.718281828, -(npm / ((273.15 + bmp.readTemperature()) * 29.263))) / 100.0;  
